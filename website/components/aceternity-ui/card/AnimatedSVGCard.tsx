...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto py-8 px-3 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.60)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className,
      )}
    >
      {children}
...
export const CardTitle = ({
  ...
  return (
    <h3
      className={cn(
        "text-lg font-semibold text-gray-800 dark:text-white py-2 font-heading",
        className,
      )}
    >
      {children}
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "text-sm font-normal text-neutral-600 dark:text-neutral-400 max-w-sm font-heading",
        className,
      )}
    >
      {children}
...
//     },
//     {
//       wrap: "h-8 w-8 circle-3",
//       icon: <FaGoogle className="h-4 w-4 text-white" />,
//     },
//   ],
...
//     {
//       wrap: "h-11 w-11 circle-2",
//       icon: <FaServer className="h-6 w-6  text-white" />,
//     },
...
//     {
//       wrap: "h-8 w-8 circle-3",
//       icon: <GoCopilot className="h-4 w-4  text-white" />,
//     },
//   ],
...
//     {
//       wrap: "h-12 w-12 circle-2",
//       icon: <FaSyncAlt className="h-6 w-6 text-white" />,
//     },
//     {
//       wrap: "h-11 w-11 circle-2",
...
//       <Card>
//         <CardSkeletonContainer>
//           <Skeleton serviceType={serviceType} />
//         </CardSkeletonContainer>
...
// const Skeleton = ({ serviceType }: { serviceType: ServiceType }) => {
//   const icons = SERVICE_ICON_MAP[serviceType];
...
//       <div className="flex flex-row shrink-0 justify-center items-center gap-2">
//         {icons.map((item, i) => (
//           <Container key={i} className={item.wrap}>
//             {item.icon}
//           </Container>
//         ))}
//       </div>
...
//   <div
//     className={cn(
//       "max-w-sm w-full mx-auto py-8 px-3 rounded-xl  dark:bg-[rgba(40,40,40,0.60)] bg-gray-100 shadow-lg group",
//       className
//     )}
//   >
//     {children}
...
//   children: React.ReactNode;
// }) => (
//   <div className="h-[15rem] md:h-[20rem] rounded-xl z-40 bg-neutral-300 dark:bg-[rgba(40,40,40,0.70)] bg-transparent">
//     {children}
//   </div>
// );
